...
export default function SkillCard(props) {
  ...
  return (
    <div className="flex flex-col   w-[300px]  h-80 p-4 mt-12 rounded-lg justify-center items-center relative shadow-lg  ">
      <div className=" size-[100px] bg-blue-light rounded-full absolute -top-10 left-[cal(50%-50px)]  flex justify-center items-center ">
        {icon}
      </div>
